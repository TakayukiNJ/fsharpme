                        ...
                        <div class="card-body">
                            @if (session('resent'))
                                <div class="alert alert-success" role="alert">
                                    新しい認証のリンクを、登録したメールアドレスに送信しました。<br>
                            ...
                            <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                @csrf
                                <button type="submit" class="btn-lg btn btn-link align-baseline">こちらをクリックしてください。</button>.
                            </form>
                            <br>
                            ...
                            <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                @csrf
                                <button type="submit" class="btn-lg btn btn-link align-baseline">{{ __('click here to request another') }}</button>.
                            </form>
                        </div>
                    </div>
                </div>
